...
@Data
@Configuration
@ConfigurationProperties(prefix = "dataio.datasource.druid")
@MapperScan(basePackages = dataIoDataSource.PACKAGE, sqlSessionFactoryRef = "backSqlSessionFactory")
public class dataIoDataSource {
    /**
     * dao层的包路径
     */
    static final String PACKAGE = "com.yc.dataIo.mapper";
